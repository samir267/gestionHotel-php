    ...
    <div class="modal-content">
      <form>
        ...
        <div class="modal-body">
          ...
          <input type="text" class="form-control" value="<?php echo $aa?>" name="id" hidden>
          ...
          <div class="form-group">
            ...
            <input type="text" class="form-control" required value="<?php echo $user->password ?>" name="password">
          </div>
          <div class="form-group">
            <label>Telephone</label>
            <input type="text" class="form-control" required value="<?php echo $user->telephone ?>" name="telephone">
          </div>
        </div>
